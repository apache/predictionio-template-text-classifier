...
%https://docs.prediction.io/api/current/#io.prediction.controller.LServing
 ...
 A predictive model needs to be evaluated to see how it will generalize to future observations. PredictionIO uses cross-validation to perform evaluation metric estimates needed to assess your particular model. Our
