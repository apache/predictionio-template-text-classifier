...
We will be using Scikit Learn's datasets and text module. Let's get a better feel for the data: initialize your Python interpreter and type the following lines:
