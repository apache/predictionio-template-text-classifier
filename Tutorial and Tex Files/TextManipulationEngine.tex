...
\encircled{\bf{Evaluation}} & \ar[l]_(0.29){\text{Predicted Result}}^(0.3){\text{Actual Result}} \\
\encircled{\bf{Event Server}} \ar[r]^(0.7){\text{Event}} & \\
& \ar@<1ex>[ldd]^(0.3){\text{Predicted Result}} \\
& \\
\encircled{\bf{Your Web/App}} \ar@<1ex>[ruu]^(0.7){\text{Query}} \ar[uuu]^{\text{Text Data}}& 
}
\rected{
...
This is a quick start guide for those who want to start using the engine right away. For more detailed information, read the corresponding sections below.
